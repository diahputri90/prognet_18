<?php $__env->startSection('judul','Admin | Home Page'); ?>
...
<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          ...
          <a class="navbar-brand brand-logo-mini" href="/admin"><img src="<?php echo e(asset('assets/admin/images/logo-mini.svg')); ?>" alt="logo"/></a>
        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title">Grafik Pendapatan per Bulan dalam tahun <?php echo e($tahun); ?></p>
  ...
  <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php for($i=0; $i<12; $i++): ?>
      <?php if($i==$item->bulan): ?>
        <input type="hidden" name="<?php echo e($i); ?>" value="<?php echo e($item->pendapatan); ?>">
        <?php break; ?>
      <?php else: ?>
   ...
   <script>
    window.onload = function () {
      ...
      var chart = new CanvasJS.Chart("chartContainer", {
        ...
        title:{
          text: "Pendapatan per Bulan dalam Tahun <?php echo e($tahun); ?>"
        },
        axisX: {
          interval:1,
          labelMaxWidth: 180,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kuliah\SMESTER 4\PRAKTIKUM\PROGNET\ulang\praktikum_prognet-master\resources\views/admin/home.blade.php ENDPATH**/ ?>