<?php $__env->startSection('judul','User | Detail Produk Page'); ?>
      ...
      <div class="modal-body">
        ...
        <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="row" style="margin-bottom: : 10px; margin-top: 10px;">
                <div class="col-md-6">
                    <div style="background-color: #ddd4bd; padding: 5px 15px; border-radius: 10px;">
                        <p style="margin: 0; font-size: 10px;"><?php echo e($review->name); ?></p>
                        <p style="margin: 0; color: black;"><?php echo e($review->content); ?></p>                        
                    </div>
                </div>
            </div>
            <?php $__currentLoopData = $response; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($review->id == $item->review_id): ?>
                <div class="row" style="margin-bottom: 10px;">
                    <div class="col-md-6 ml-auto">
                        <div style="background-color: #7ed957; padding: 5px 15px; border-radius: 10px;">
                            <p style="margin: 0; font-size: 10px;"><?php echo e($review->name); ?></p>
                            <p style="margin: 0;"><?php echo e($review->content); ?></p> 
                            <hr>
                            <p style="margin: 0; font-size: 10px;"><?php echo e($item->name); ?></p>
                            <p style="margin: 0; color: black;"><?php echo e($item->content); ?></p>                        
                        </div>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <div class="modal fade" id="checkout" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="/users/checkout/<?php echo e($product->id); ?>" method="POST">
                      <?php echo csrf_field(); ?>
                ...
                <div class="cart-page-heading">
                    ...
                    <form class="btn-submit" method="POST">
                        ...
                        <ul class="order-details-form mb-4">
                            ...
                            <li><span>Deskripsi</span> <span><?php echo e($product->description); ?></span></li>
                            <li><span>Diskon</span> <span><?php echo e($diskon); ?>%</span></li>
                            <li><span>Harga Satuan</span> <span>Rp. <?php echo e($price); ?></span></li>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Kuliah\SMESTER 4\PRAKTIKUM\PROGNET\ulang\praktikum_prognet-master\resources\views/user/product_detail.blade.php ENDPATH**/ ?>